...
export default function PipelineCaseStudy() {
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-slate-900 mb-2">Case Study Generator</h2>
        <p className="text-slate-500 mb-6">Upload screenshots, input traffic and revenue data, and link the old site — our AI will generate a narrative case study proving your impact. This feature is coming soon.</p>
