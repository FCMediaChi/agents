...
import CaseStudyGenerator from './pages/pipeline/CaseStudyGenerator'
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/pipeline/case-study" element={<PipelineProtectedRoute><CaseStudyGenerator /></PipelineProtectedRoute>} />
